...
// Função para salvar o nome
  ...
  Future<void> _salvarNome() async {
    ...
    final nome = _ctrlNome.text
        .trim(); // trim funçao que remove os espaços em branco no texteditingcontroller
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Digite um nome e salve localmente com SharedPreferences',
            ...
            TextField(
              ...
              textInputAction:
                  TextInputAction.done, // Açao do texto no textfield
            ...
            Row(
              children: [
                ...
                Expanded(
                    child: OutlinedButton.icon(
                  onPressed: _nomes.isEmpty ? null : _limparTudo,
                  label: Text('Remover'),
